...
function audio_play() {
	...
	document.getElementById('audio-time-left').innerHTML = convert_time(current_duration);
...
function audio_progress_update () {
	...
	document.getElementById('audio-seekbar').value = current_time / current_duration;

	document.getElementById('audio-current-time').innerHTML = convert_time(current_time);
	document.getElementById('audio-time-left').innerHTML = convert_time(parseInt(current_duration - current_time));
}
	...
	switch (set) {
		case "intro":
			...
			track_list = [
				...
				['audio/production/ewdangerousroads.mp3', 'Dangerous Roads'],
				['audio/production/tabfh/messenger.mp3', 'TABFH - Messenger'],
				['audio/production/roseglasses.mp3', 'Rose Glasses'],
				['audio/production/tryme.mp3', 'Try Me'],
				['audio/production/helium.mp3', 'TABFH - Helium'],
				['audio/production/dbsd/3_backhome.mp3', 'Lyell - Back Home'],
